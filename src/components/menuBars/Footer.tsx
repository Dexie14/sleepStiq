...
const Footer = () => {
  return (
    <div className="bg-[url('/footerImage.png')] xl:px-28 px-5 py-7 bg-primary">
      ...
      <section className="pt-12 flex lg:flex-row flex-col space-y-8 lg:space-y-0 justify-between">
        <div className="flex gap-12  lg:w-[31%]">
        ...
        <div className="lg:w-[30%] flex gap-11">
